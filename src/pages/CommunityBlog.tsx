...
import { Calendar, PenLine, Loader2, Trash2, ArrowLeft } from "lucide-react";
      ...
      <main className="pt-32 pb-20">
        <section className="container mx-auto px-4 mb-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">Community Blog</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Stories, reflections and conversations from our community. Sign in to share your own.
            </p>
          </motion.div>
        </section>
