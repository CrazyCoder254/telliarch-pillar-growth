    ...
    <section id="about" className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="mb-6">About TELLIARCH LIMITED</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card className="shadow-elegant hover:shadow-glow transition-smooth border-none">
            <CardContent className="p-8 text-center">
              <div className="w-16 h-16 gradient-primary rounded-full flex items-center justify-center mx-auto mb-4">
                <Target className="text-white" size={32} />
              </div>
              <h3 className="mb-4 text-xl">Mission</h3>
          ...
          <Card className="shadow-elegant hover:shadow-glow transition-smooth border-none">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="mb-4 text-xl">Vision</h3>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="shadow-elegant hover:shadow-glow transition-smooth border-none">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="mb-4 text-xl">Our Story</h3>
              <p className="text-muted-foreground leading-relaxed">
