        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item, i) => (
            <motion.div
              ...
              className="group bg-card rounded-2xl p-6 shadow-elegant hover:shadow-glow transition-smooth border border-border/50"
            >
              <div className="w-14 h-14 rounded-xl gradient-accent flex items-center justify-center mb-4 group-hover:scale-110 transition-smooth">
                <item.icon className="text-white" size={26} />
              </div>
              <h3 className="text-lg font-bold mb-2 text-card-foreground">{item.title}</h3>
