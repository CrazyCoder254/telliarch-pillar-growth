    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground">Programs Built for Impact</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {programs.map((p, i) => (
            <motion.div
              ...
              className="relative bg-card rounded-2xl overflow-hidden shadow-elegant hover:shadow-glow transition-smooth border border-border/50 group"
            >
